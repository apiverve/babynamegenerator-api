...
[![RubyGems](https://img.shields.io/badge/RubyGems-E9573F?style=flat&logo=rubygems&logoColor=white)](https://rubygems.org/gems/apiverve_babynamegenerator)
[![Packagist](https://img.shields.io/badge/Packagist-F28D1A?style=flat&logo=packagist&logoColor=white)](https://packagist.org/packages/apiverve/babynamegenerator)
[![Go](https://img.shields.io/badge/Go-00ADD8?style=flat&logo=go&logoColor=white)](#-go)
[![Dart](https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white)](https://pub.dev/packages/apiverve_babynamegenerator)
...
```bash
curl -X GET "https://api.apiverve.com/v1/babynamegenerator?gender=male" \
...
```bash
gem install apiverve_babynamegenerator
```

[**View RubyGems Package →**](https://rubygems.org/gems/apiverve_babynamegenerator) | [**Package Code →**](./ruby/)
...
[**View Packagist Package →**](https://packagist.org/packages/apiverve/babynamegenerator) | [**Package Code →**](./php/)
...
```bash
dart pub add apiverve_babynamegenerator
```

[**View pub.dev Package →**](https://pub.dev/packages/apiverve_babynamegenerator) | [**Package Code →**](./dart/)
