...
namespace APIVerve\Babynamegenerator;
...
/**
 * Client for the Baby Name Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/babynamegenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/babynamegenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BabynamegeneratorClient] {$message}\n";
        }
    }
}
