...
namespace APIVerve.API.BabyNameGenerator
{
    ...
    /// <summary>
    /// Client for the BabyNameGenerator API
    /// </summary>
...
#endif
    {
        ...
        {
            { "gender", new ValidationRule { Type = "string", Required = true } },
        ...
        private void ValidateParams(BabyNameGeneratorQueryOptions options)
        {
