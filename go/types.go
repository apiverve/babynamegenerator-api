...
// Request contains the parameters for the Baby Name Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Baby Name Generator API.
type ResponseData struct {
	Count int `json:"count"`
	Names []NamesItem `json:"names"`
}

// NamesItem represents an item in the Names array.
