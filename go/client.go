// Package babynamegenerator provides a Go client for the Baby Name Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/babynamegenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/babynamegenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Baby Name Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Baby Name Generator API client.
...
// Execute makes a request to the Baby Name Generator API with typed parameters.
//
...
//   - gender (required): string - The gender for the generated names
//   - count: integer - The number of names to generate [min: 1, max: 100]
